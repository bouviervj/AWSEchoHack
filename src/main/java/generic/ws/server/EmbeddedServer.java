...
public class EmbeddedServer {
	...
	public static void buildDirectory(){
		...
		_sDirectory = "."+File.separator+"ws-jetty-tmp";
	...
	public static String  workDirectory(){
		...
		// Create directory if not exists
		_wDirectory = "."+File.separator+"js-work";
	...
	public static Server buildServer(int iPortHttp, int iPortHttps){
		...
		InputStream aStream = server.getClass().getResourceAsStream("/servlet/WEB-INF/classes/server.jks");
		String aFileKeyStore = _sDirectory+File.separator+"server.jks";
		try {
		...
		sslContextFactory.setKeyStorePath(aFileKeyStore);
		sslContextFactory.setKeyStorePassword("test0001");
		sslContextFactory.setKeyManagerPassword("test0001");
		sslContextFactory.setTrustStorePath(aFileKeyStore);
		sslContextFactory.setTrustStorePassword("test0001");
